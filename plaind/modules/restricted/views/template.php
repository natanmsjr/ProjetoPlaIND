...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/restrictedCSS/skin-blue.css">
    <!-- Ionicons -->
...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <ul class="nav navbar-nav">
                        ...
                        <ul class="menu">
                          <li><!-- start message -->
                            <a href="#">
                              <div class="pull-left">
                                <!-- User Image -->
                                <img src="../assets/images/testimonial/02.jpg" class="img-circle" alt="User Image">
                              </div>
                  ...
                  <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <img src="../assets/images/testimonial/02.jpg" class="user-image" alt="User Image">
  ...
  <!-- /.content-wrapper -->
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        Copyright &copy; Pla<strong>IND</strong> 2017
      </footer>
